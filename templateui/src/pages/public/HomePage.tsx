const HomePage = () => {
  return (
    <div className='pageTemplate1'>
      <div className='w-full flex justify-center items-center gap-4  border-white rounded-[300px] ring-4 p-10'>
        <div className='flex-1 flex flex-col justify-center items-start gap-8 ml-16 -mt-8'>
          ...
          <h1 className='text-[38px] leading-6 font-bold text-white'></h1>
          <div className='space-y-1 text-[35px] leading-6 font-bold text-white'>
            ...
            <h1 className='text-3xl leading-6'></h1>
          </div>
        </div>
